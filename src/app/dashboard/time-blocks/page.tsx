...
import { OnAgainOffAgainPlanner } from '@/components/dashboard/OnAgainOffAgainPlanner';

export const metadata = {
  title: 'On Again / Off Again | Marlie LMS',
...
export default async function TimeBlocksPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-base light-ambient-surface">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8 pb-24 md:pb-12">
        <OnAgainOffAgainPlanner events={calendarEvents} />
      </main>
    </div>
  );
}
