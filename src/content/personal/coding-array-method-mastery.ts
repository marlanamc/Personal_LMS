        ...
        // Introduction
        {
            ...
            explanation: `
                <div style="background: linear-gradient(135deg, rgba(14, 165, 233, 0.1) 0%, rgba(99, 102, 241, 0.1) 100%); padding: 1.5rem; border-radius: 0.5rem; margin-bottom: 1.5rem;">
                    <p style="font-size: 1.125rem; margin-bottom: 0;">Array methods are the most powerful tools in JavaScript. Master map, filter, reduce, and friends to write elegant, functional code!</p>
                </div>
