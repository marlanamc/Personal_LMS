    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className={cn('absolute inset-0 flex items-center justify-center p-3 sm:p-4', contentClassName)}>
        <div
          ...
          tabIndex={-1}
          className={cn(
            'flex w-full max-h-[85svh] flex-col overflow-hidden rounded-[2rem] border border-border-subtle/40 bg-bg-surface shadow-2xl outline-none overscroll-contain animate-in zoom-in-95 duration-300 sm:max-h-[90vh] sm:max-w-lg sm:rounded-[1.75rem]',
            panelClassName,
          )}
        >
          {children}
