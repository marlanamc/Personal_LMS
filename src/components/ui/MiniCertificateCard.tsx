...
export function MiniCertificateCard({ certificate, className = "" }: MiniCertificateCardProps) {
    ...
    const palette = {
        bronze: {
            bgGradient: "from-amber-100 via-orange-50 to-amber-100 dark:!from-amber-100 dark:!via-orange-50 dark:!to-amber-100",
            border: "border-amber-300 hover:border-amber-500 dark:!border-amber-300 dark:hover:!border-amber-500",
            badge: "bg-amber-100 text-amber-800 border-amber-300 dark:!bg-amber-100 dark:!text-amber-800 dark:!border-amber-300",
            title: "text-amber-950 group-hover:text-amber-800 dark:!text-amber-950 dark:group-hover:!text-amber-800",
            score: "text-amber-950 dark:!text-amber-950",
            date: "text-amber-900/80 dark:!text-amber-900",
        },
        silver: {
            bgGradient: "from-slate-100 via-gray-50 to-slate-100 dark:!from-slate-100 dark:!via-gray-50 dark:!to-slate-100",
            border: "border-slate-300 hover:border-slate-500 dark:!border-slate-300 dark:hover:!border-slate-500",
            badge: "bg-slate-100 text-slate-800 border-slate-300 dark:!bg-slate-100 dark:!text-slate-800 dark:!border-slate-300",
            title: "text-slate-900 group-hover:text-slate-700 dark:!text-slate-900 dark:group-hover:!text-slate-700",
            score: "text-slate-950 dark:!text-slate-950",
            date: "text-slate-700 dark:!text-slate-700",
        },
        gold: {
            bgGradient: "from-amber-100 via-yellow-50 to-amber-100 dark:!from-amber-100 dark:!via-yellow-50 dark:!to-amber-100",
            border: "border-amber-300 hover:border-amber-500 dark:!border-amber-300 dark:hover:!border-amber-500",
            badge: "bg-amber-100 text-amber-800 border-amber-300 dark:!bg-amber-100 dark:!text-amber-800 dark:!border-amber-300",
            title: "text-amber-950 group-hover:text-amber-800 dark:!text-amber-950 dark:group-hover:!text-amber-800",
            score: "text-amber-950 dark:!text-amber-950",
        ...
        platinum: {
            bgGradient: "from-cyan-100 via-sky-50 to-cyan-100 dark:!from-cyan-100 dark:!via-sky-50 dark:!to-cyan-100",
            border: "border-cyan-300 hover:border-cyan-500 dark:!border-cyan-300 dark:hover:!border-cyan-500",
            badge: "bg-cyan-100 text-cyan-800 border-cyan-300 dark:!bg-cyan-100 dark:!text-cyan-800 dark:!border-cyan-300",
            title: "text-slate-900 group-hover:text-cyan-800 dark:!text-slate-900 dark:group-hover:!text-cyan-800",
            score: "text-slate-950 dark:!text-slate-950",
            date: "text-slate-700 dark:!text-slate-700",
        },
    }[tier];
