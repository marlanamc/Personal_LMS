...
export const ClassAnnouncement: React.FC<ClassAnnouncementProps> = ({ announcements }) => {
    ...
    return (
        <section className="animate-fade-in-up delay-75">
            <div className="relative overflow-hidden glass-card rounded-2xl p-4 sm:p-5 border border-border-subtle bg-bg-surface shadow-md transition-all duration-300 max-w-4xl">
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-sakura-soft flex items-center justify-center text-primary">
                        ...
                        <button
                            ...
                            className="p-1.5 sm:p-2 rounded-lg hover:bg-sakura-soft text-primary transition-colors flex items-center gap-1 text-xs sm:text-sm font-semibold border border-border-subtle bg-bg-elevated"
                    ...
                    {!isCollapsed && (
                        <div className="mt-4 space-y-4 animate-fade-in">
                            {announcements.map((announcement, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-4 p-4 rounded-xl bg-bg-surface border border-border-subtle shadow-sm hover:shadow-md hover:bg-bg-elevated transition-all duration-300">
